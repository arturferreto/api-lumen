...
$router->group(['middleware' => ValidateDataMiddleware::class], function() use ($router) {
    ...
    $router->group(['prefix' => 'api/v1', 'namespace' => 'V1', 'as' => News::class], function() use ($router) {
        $router->post('/noticias', ['uses' => 'NewsController@create']);
        ...
        $router->put('/noticias/{param}', ['uses' => 'NewsController@editBy']);
